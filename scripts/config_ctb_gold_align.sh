...
export TRAIN_FILE="${JAMR_HOME}/data/ctb_gold_align_annotation/ctb_train.txt"
export DEV_FILE="${JAMR_HOME}/data/ctb_gold_align_annotation/ctb_dev.txt"
export TEST_FILE="${JAMR_HOME}/data/ctb_gold_align_annotation/ctb_test.txt"

export MODEL_DIR="${JAMR_HOME}/models/ctb_gold_align"  # ideally keep this the same as the config_SOMETHING.sh
