...
export TRAIN_FILE="${JAMR_HOME}/data/chinese_lp_train_as_test/blj_train.txt"
export DEV_FILE="${JAMR_HOME}/data/chinese_lp_train_as_test/blj_dev.txt"
export TEST_FILE="${JAMR_HOME}/data/chinese_lp_train_as_test/blj_train.txt"

export MODEL_DIR="${JAMR_HOME}/models/eval_on_train"  # ideally keep this the same as the config_SOMETHING.sh
